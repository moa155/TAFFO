...
\midrule
\verb|@weights| (array) & $[-0.8,0.8]$ &
  $[-0.8,0.8]$ + \texttt{components} $=$
  $\{[-0.8,-0.8],[-0.7,-0.2],[0.2,0.7],[0.8,0.8]\}$ \\[0.3em]
\verb|%5 = load weights[ii]| & $[-0.8,0.8]$ & same 4 components \\[0.3em]
\textbf{\verb|%6 = fdiv 1.0, %5|} & \textbf{$[-10^8,10^8]$} &
...
\begin{axis}[
  ...
  ylabel=\,,
  symbolic y coords={classic s28\_4fixp, donut s4\_28fixp},
  ytick=data,
...
\addplot+[fill=red!65, draw=red!80!black] coordinates {
  (28, classic s28\_4fixp) (4, donut s4\_28fixp)
};
\addplot+[fill=blue!55, draw=blue!75!black] coordinates {
  (4, classic s28\_4fixp) (28, donut s4\_28fixp)
};
