...
int main(int argc, char** argv) {
  ...
  POLYBENCH_1D_ARRAY_DECL(A, DATA_TYPE __attribute__((annotate("target('A') scalar(range(0,0))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(B, DATA_TYPE __attribute__((annotate("scalar(range(0,0))"))), N, n);
