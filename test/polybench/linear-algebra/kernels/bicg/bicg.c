...
int main(int argc, char** argv) {
  ...
  //POLYBENCH_1D_ARRAY_DECL(s, DATA_TYPE __attribute__((annotate("target('s') scalar(range(-256, 255) )"))), M, m); //OLD VRA
  //POLYBENCH_1D_ARRAY_DECL(q, DATA_TYPE __attribute__((annotate("target('q') scalar(range(-256, 255) )"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(s, DATA_TYPE __attribute__((annotate("target('s') scalar(range(0, 0) )"))), M, m);
  POLYBENCH_1D_ARRAY_DECL(q, DATA_TYPE __attribute__((annotate("target('q') scalar(range(0, 0) )"))), N, n);
